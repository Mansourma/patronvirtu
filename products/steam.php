...
$products = fetchProductsByCategory('steam');
...
$sql = "SELECT COUNT(*) AS total FROM products WHERE category = 'steam'";
...
$sql = "SELECT * FROM products WHERE category = 'steam' LIMIT $start, $limit";
$result = $conn->query($sql);
?>
...
<head>
    ...
    <title>Ecommerce Website - Steam Category</title>
