...
<body>
    ...
    $products = fetchProductsByCategory('security');
...
$sql = "SELECT COUNT(*) AS total FROM products WHERE category = 'security'";
...
$sql = "SELECT * FROM products WHERE category = 'security' LIMIT $start, $limit";
$result = $conn->query($sql);
    ?>

    <h1>Security Category</h1>
