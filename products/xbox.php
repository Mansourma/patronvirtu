...
<body>
    ...
    $products = fetchProductsByCategory('xbox');
...
$sql = "SELECT COUNT(*) AS total FROM products WHERE category = 'xbox'";
...
$sql = "SELECT * FROM products WHERE category = 'xbox' LIMIT $start, $limit";
$result = $conn->query($sql);
    ?>
