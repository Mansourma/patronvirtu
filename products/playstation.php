...
<body>
    ...
    $products = fetchProductsByCategory('playstation');
    $limit = 10; 
    $page = isset($_GET['page']) ? $_GET['page'] : 1; 
    $start = ($page - 1) * $limit; 

    
    $sql = "SELECT COUNT(*) AS total FROM products WHERE category = 'playstation'";
    ...
    $sql = "SELECT * FROM products WHERE category = 'playstation' LIMIT $start, $limit";
    $result = $conn->query($sql);

    ?>

    <h1>Playstation Category</h1>
