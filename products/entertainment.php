...
<body>
    ...
    $products = fetchProductsByCategory('entertainment');
...
$sql = "SELECT COUNT(*) AS total FROM products WHERE category = 'entertainment'";
...
$sql = "SELECT * FROM products WHERE category = 'entertainment' LIMIT $start, $limit";
$result = $conn->query($sql);
    ?>
